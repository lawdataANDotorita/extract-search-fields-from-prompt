...
סוג פסק דין:
יכול להיות גזר דין/החלטה/פסק דין/פסק בורר/הכרעת דין
...
חיפוש טקסטואלי:
ייתכן והפרומפט יכיל תיאור של בעיה או מקרה. אם כך הדבר, אנא תרגם את התיאור לשני התחומים המשפטיים המדוייקים ביותר שמתייחסים לכל המקרה המתואר ומקיפים אותו. כל תחום צריך להיות בן שתי מילים מקסימום.
שם הביטוי הראשון:T1
שם הביטוי השני:T11
...
//			{ role: 'user', content: oInputs.text }
			{ role: 'user', content: "תיקים מתביעות קטנות שהשופט בהם הוא מיוחס" }
