...
מזהה תיק: 
מזהה התיק בדרך כלל מורכב ממספר מחולק ע"י מחיצות בדמות מקפים או לוכסנים. לעיתים יופיע גם סוג תיק שהוא מחרוזת בת שתיים עד ארבע אותיות ויכולה לכלול גם גרשיים.
אתה אמור להחזיר עד שלושה שדות.
Tik - מזהה של התיק, יכול להופיע כמספר או כשני מספרים שביניהם חוצץ מקף
Tik_Ref - שנת התיק, מופיע אחרי הלוכסן או המקף האחרון ומכיל שתי ספרות שמייצגות שנה
